%% Function for Feature Extraction and Pointcloud Generation (Simulation, DTM)
% Author: JoeyBG.
% Improved By: JoeyBG.
% Time: 2025/5/29.
...
%% Function Body
function PointCloud = Feature_Extraction_SimHDTM(Data_Path)
    ...
    yticklabels({num2str(Max_Doppler),num2str(Max_Doppler/2),'0',num2str(-Max_Doppler/2),num2str(-Max_Doppler)});
