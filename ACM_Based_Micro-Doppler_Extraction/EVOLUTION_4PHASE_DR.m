%% Function for Evolution of Four-Phase Level Set Segmentation with Distance Regularization
% Author: Chunming Li.
% Improved By: JoeyBG.
% Time: 2025/5/26.
...
% with an additional distance regularization term. It takes an image I and initial level set
% functions phi0 (with two components), and evolves the level set functions over a specified
% number of iterations using a combination of curvature, data fitting, and distance regularization
% terms. The evolution is governed by parameters nu, lambda_1, lambda_2, mu, with time step
% delta_t and epsilon for the Dirac delta approximation.
%
...
% The distance regularization term is based on the discrete Laplacian and curvature, as described
% in Li's CVPR 2005 paper.
%
% Inputs:
...
%   mu - scalar weight for the distance regularization term.
